...
function f4() {
    ...
    if (s4.has(input)) {document.querySelector('.out-4').textContent = true}
    else document.querySelector('.out-4').textContent = false;
...
function f7() {
    ...
    console.log('[s7]', s7);
    if (s7.size > 6) {document.querySelector('.out-7').textContent = 1}
    else if (s7.size <= 6) {document.querySelector('.out-7').textContent = 0;}

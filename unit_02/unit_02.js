...
let e1 = '3';
let f1 = 5;
let r = ' операция конкатенация. Строка e1 приконкатенировала к числу f1';

document.querySelector('.out-4').textContent = e1 + f1 + r;
...
function t10() {
    div10.textContent = +input10.value * 10;
}
...
let input12First = document.querySelector('.i-12_1');
let input12Second = document.querySelector('.i-12_2');
let div12 = document.querySelector('.out-12');

function t12() {
    let name = input12First.value;
    let surname = input12Second.value;

    div12.textContent = 'Hello ' + name + ' ' + surname;
}
...
let input13First = document.querySelector('.i-13_1');
let input13Second = document.querySelector('.i-13_2');
let div13 = document.querySelector('.out-13');

function t13() {
    let a = +input13First.value;
    let b = +input13Second.value;
...
document.querySelector('.i-16_1').type = 'number';
document.querySelector('.i-16_2').type = 'number';
let div16 = document.querySelector('.out-16');

function t16() {
    let input16First = +document.querySelector('.i-16_1').value;
    let input16Second = +document.querySelector('.i-16_2').value;

    div16.textContent = input16First + input16Second;
}
...
let input19First = document.querySelector('.i-19_1');
let input19Second = document.querySelector('.i-19_2');
let div19 = document.querySelector('.out-19');

function t19() {
    let a = parseInt(input19First.value);
    let b = parseInt(input19Second.value);
...
function t20() {
    ...
    let surname = document.querySelector('.i-20_2').value;
    let age = document.querySelector('.i-20_3').value;
    let profession = document.querySelector('.i-20_4').value;
    let div20 = document.querySelector('.out-20');

    div20.textContent = 'Уважаемый ' + name + ', ' + surname + ', ваш возраст ' +  age + ' года, по професии Вы ' + profession;
}

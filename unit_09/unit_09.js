...
function f6() {
    let paragraf = document.querySelectorAll('.p-6');
    document.querySelector('.out-6').textContent = paragraf.length;
...
function f18() {
    let paragraf = document.querySelector('.p-18');       
    document.querySelector('.out-18').textContent = paragraf.getAttribute('data-b');
}
...
function f19() {
    let paragraf = document.querySelectorAll('.p-19');

    for (let i = 0; i < paragraf.length; i++) {
        document.querySelector('.out-19').textContent += paragraf[i].getAttribute('data-b') + ' ';
    }
}

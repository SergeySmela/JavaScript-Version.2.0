...
// let ar6 = 
let ar6 = ['sergey', 'teresu', 'monday', 'october'];
...
// Task 11
// Напишите функцию, которая меняет местами второй (индекс 2) и четвертый (индекс 4) элемент массива ar12 и выводит его в out-11. Разделитель - пробел.

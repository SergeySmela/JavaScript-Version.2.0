...
document.querySelector('.three').innerHTML = '<h3>Tasc 10</h3>';
...
document.querySelector('.four').innerHTML += '<h4>lorem1</h4><p>lorem10</p>';
...
document.querySelector('.z1z2').innerHTML = z1 * z2;
...
let y1 = 6;
let y2 = 3;
document.querySelector('.y1y2').innerHTML = y1 / y2;
...
let x1 = 'Hello';
let x2 = 5;
document.querySelector('.Hello5').innerHTML = x1 + x2;

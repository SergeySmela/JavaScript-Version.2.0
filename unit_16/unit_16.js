...
function f3() {
    let arrDivov = document.getElementsByClassName('out-3');
    
    for (const iterator of arrDivov) {
...
function f4() {
    let arr = document.querySelectorAll('.out-4');

    for (let i = 0; i < arr.length; i++) {
        arr[i].textContent = arr[i].textContent + 4;
    }

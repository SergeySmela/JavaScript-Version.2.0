...
const checkbox4 = document.querySelector('.i-4');
const div4 = document.querySelector('.out-4');

function f4() {
    if (checkbox4.checked) {div4.textContent = true}
    else {div4.textContent = false}
...
function f5() {
    if (checkbox5.checked) {div5.textContent = checkbox5.value;}
    else {div5.textContent = false}
...
function f7() {
    div71.textContent = input7.value;

    if (input7.value.length >= 6) {div72.textContent = 1}
    else {div72.textContent = 0}
}
...
function f8() {
    div8.innerHTML += '<input type="text" class="i-81" value="TEST"><button class="button-primary b-81">New BTN</button><div class="out-81"></div>';
...
function f9() {
    if (input9.checked) {div9.textContent = input9.value;}
...
function f12() {
    div12.textContent = input12.value;
...
function f13() {
    div13.textContent = input13.value;
...
const input14 = document.querySelector('.t-14');
const div14 = document.querySelector('.out-14');

function f14() {
    div14.textContent = input14.value;
}
...
const input15Area = document.querySelector('.t-15');
const div15 = document.querySelector('.out-15');


function f15() {
    div15.textContent = input15.value;
    input15Area.value = input15.value;
}
...
function f16() {
    div16.textContent = input16.value;
...
function f17() {
    div17.textContent = input17.value;
}
...
const selest18 = document.querySelector('.s-18');
const input18 = document.querySelector('.i-18');

function f18() {
    input18.value = selest18.value;

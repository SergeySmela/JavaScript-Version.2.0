...
function f6() {
    let lastIndex = d6.length;
    d6[lastIndex] = document.querySelector('.i-6').value;
...
function f11() {
    ...
    if (d11.indexOf(a) < 0) {document.querySelector('.out-11').textContent = -1}
    else {document.querySelector('.out-11').textContent = d11.indexOf(a)}
...
function f17() {
    ...
    concatArrays(d17, d171);
    concatArrays(d17, d172);
...
function f18() {
    ...
    let a = d18.includes(input);
    console.log(a);
    console.log(input);
    document.querySelector('.out-18').textContent = a;
...
function f19() {
    for (let i = 0; i < d19.length; i++) {
        while (maxString.length < d19[i].length) {
            maxString = d19[i];
        }
    }

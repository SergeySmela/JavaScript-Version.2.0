...
function t1() {
    xml.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=1');
    xml.send();
...
function t2() {
    xml.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=sergey');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t3() {
    xml.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=3&num2=7');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t4() {
    xml.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=1&num2=8');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t5() {
    xml.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=5');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t6() {
    xml.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=45&num2=89');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t7() {
    xml.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=7');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            document.querySelector('.out-7').innerHTML =  xml.response;
        }
    }
}
...
function t8() {
    xml.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=2002');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t9() {
    xml.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=9&y=1');
    // &m=1&d=1
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t10() {
    xml.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=1');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t11() {
    xml.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=sergey');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t12() {
    xml.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=3&num2=5');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t13() {
    xml.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=12&num2=36');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t14() {
    xml.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=5');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t15() {
    xml.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=3&num2=90');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t16() {
    xml.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=7');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t17() {
    xml.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1980');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t18() {
    xml.open('POST', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=9&d=1');
    xml.send();
    xml.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {

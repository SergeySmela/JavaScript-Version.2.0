...
function f7() {
    ...
    for (const key in a7) {
        ...
        if (key == input7) {document.querySelector('.out-7').textContent = 1;break}
...
function f8() {
    ...
    for (const key in a8) {
        if (key == input8) {document.querySelector('.out-8').textContent = a8[key];break}
        else document.querySelector('.out-8').textContent = 0;
    }
...
function f13() {
    ...
    for (const key in a13) {
       if (typeof a13[key] === 'number') {out = out + a13[key]}

...
function t8() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&yaer=1980')
    .then((response) => {
        return response.text();
    })
    .then((response) => {
...
function t9() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=9&y=1')
    .then((response) => {
        return response.text();
    })
    .then((response) => {
...
function t18() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=5ADcB96BA48d3f80&action=9&m=1',
    })
    .then((response) => {
        return response.text();
    })
